// thanks to http://blog.benoitvallon.com/data-structures-in-javascript/the-graph-data-structure/ for the code
...
export default class Graph {
  ...
  removeEdge(a, b) {
    const index1 = this.edges[a] ? this.edges[a].indexOf(b) : -1;
    const index2 = this.edges[b] ? this.edges[b].indexOf(a) : -1;
    if(~index1) {
      this.edges[a].splice(index1, 1);
      this.numberOfEdges--;
    }
    if(~index2) {
      this.edges[b].splice(index2, 1);
    }
  }
